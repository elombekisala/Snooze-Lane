...
struct SnoozeLaneApp: App {
    ...
    @StateObject var locationSearchViewModel = LocationSearchViewModel(locationManager: LocationManager())
    @StateObject var tripProgressViewModel = TripProgressViewModel(locationViewModel: LocationSearchViewModel(locationManager: LocationManager()))
...
//        GADMobileAds.sharedInstance().requestConfiguration.testDeviceIdentifiers = ["9899d44045852d6e501208b00aebe2c4"]
        GADMobileAds.sharedInstance().requestConfiguration.testDeviceIdentifiers = ["46c658083659f34c29e3a2de4abfb1d9"]
