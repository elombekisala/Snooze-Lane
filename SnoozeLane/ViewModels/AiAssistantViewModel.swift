...
@Observable
class AiAssistantViewModel: NSObject, ObservableObject, AVAudioRecorderDelegate, AVAudioPlayerDelegate {
    
    let client = OpenAIClient(apiKey: "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")
