...
struct WalkthroughScreen: View {
    ...
    var body: some View {
        ZStack {
            ...
            if currentPage == 1 {
                ScreenView(
                    ...
                    detail:
                        "Find your desired stop or station using the search feature or move around the map and long press on the map.",
                    startColor: Color("4"),
                    endColor: Color("5")
                )
            ...
            if currentPage == 2 {
                ...
                ScreenView(
                    ...
                    detail:
                        "Set how far from your stop you'd wish to be woken up.\n0.3 miles equals about 6 blocks away",
                    startColor: Color("4"),
                    endColor: Color("5")
                )
                .padding(.horizontal, 12)
            ...
            if currentPage == 3 {
                ...
                ScreenView(
                    ...
                    detail:
                        "We'll track your journey and you'll get a call from the when you're near your destination. Enjoy a worry-free rest!",
                    startColor: Color("4"),
                    endColor: Color("5")
                )
                .padding(.horizontal, 12)
        ...
        .safeAreaInset(edge: .bottom) {
                    ...
                    Image(systemName: "chevron.right")
                        ...
                        .overlay(
                            ZStack {
                                ...
                                Circle()
                                    .trim(
                                        from: 0, to: CGFloat(currentPage) / CGFloat(totalPages)
                                    )
            ...
            .padding(.bottom, 120)  // Extra padding above tab bar
        }
    }
}
